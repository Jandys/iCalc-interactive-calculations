...
class MainMenuFrontend extends AbstractAdminFrontend
{
    ...
    public static function configuration()
    {
        ...
        echo '
            ...
            <span class="mb-2 d-flex row col-11">
                <button id="toggleBtn" class="m-2 interactivecalculations-toggle-creation col-2 interactivecalculations-reappear" data-toggled-text="' . esc_html(__("Calculations List")) . '">' . esc_html(__("Create New Calculation")) . '</button>
                <div class="col-5"></div>
                <button id="editConfiguration" class="m-2 interactivecalculations-toggle-creation interactivecalculations-button-edit-color btn-info col-2 hidden"><i class="dashicons dashicons-admin-generic w-auto"></i>' . esc_html(__("Edit Current Configuration")) . '</button>
                <button id="saveCalculation" class="m-2 interactivecalculations-toggle-creation col-2 interactivecalculations-button-save-color btn-success hidden">' . esc_html(__("Save Calculation")) . '</button>
                <button id="editCalculation" class="m-2 interactivecalculations-toggle-creation col-2 interactivecalculations-button-save-color btn-success hidden">' . esc_html(__("Edit Calculation")) . '</button>
			</span>
                    <div id="firstDiv" class="content-div visible">
                    <h1>' . esc_html(__("Calculations List")) . '</h1>
                    ' .
            ...
            . '
                ...
                <div id="secondDiv" class="content-div interactivecalculations-hidden-slow display-none">
                    <h1>' . esc_html(__("Create New Calculation")) . ' <input type="text" id="interactivecalculations-calulation-new-name" class="ml-1 border-0 font-weight-bold w-auto" placeholder="Calculation name" /> </h1>
            ...
            . '
                 ...
                 <div id="thirdDiv" class="content-div interactivecalculations-hidden-slow display-none">
                    <h1>' . esc_html(__("Edit")) . ' <input type="text" id="interactivecalculations-calulation-edit-name" class="ml-1 border-0 font-weight-bold w-auto" placeholder="Calculation name" /> </h1>
    ...
    {
        return '<div class="interactivecalculations-draggable" draggable="true" id="draggableProduct" data-component="product-component" data-next-id="1">' . esc_html(__("Product")) . '</div>';
    }

    static function getDraggableService(): string
    {
        return '<div class="interactivecalculations-draggable" draggable="true" id="draggableService" data-component="service-component" data-next-id="1">' . esc_html(__("Service")) . '</div>';
    }


    static function getDraggableComponent(): string
    {
        return '<div class="interactivecalculations-draggable" draggable="true" id="draggableComponent" data-component="component-component" data-next-id="1">' . esc_html(__("Generic Component")) . '</div>';
    }

    static function getDraggableCalculations(): string
    {
        return '<div class="interactivecalculations-draggable" draggable="true" id="draggableCalculations" data-component="calculation-component" data-next-id="1">' . esc_html(__("Calculation Component")) . '</div>';
    }
    ...
    static function draggableConfiguration()
    {
        ...
        $returnDiv = '<div id="product-component" class="interactivecalculations-draggable-option hidden" draggable="true">
                                    <h3>' . esc_html(__("Product Component")) . '</h3>
        ...
        $returnDiv = $returnDiv . '<div id="service-component" class="interactivecalculations-draggable-option hidden" draggable="true"> 
                                <h3>' . esc_html(__("Service Component")) . '</h3>
                                <span class="interactivecalculations-configuration-bar"></span>
        ...
        $returnDiv = $returnDiv . '<div id="component-component" class="interactivecalculations-draggable-option hidden" draggable="true">
                                <h3>' . esc_html(__("Generic Component")) . '</h3>
                                <span class="interactivecalculations-configuration-bar"></span>
        ...
        $returnDiv = $returnDiv . '<div id="calculation-component" class="interactivecalculations-draggable-option hidden" draggable="true">
                                <h3>' . esc_html(__("Calculation Component")) . '</h3>
                                <span class="interactivecalculations-configuration-bar"></span>
