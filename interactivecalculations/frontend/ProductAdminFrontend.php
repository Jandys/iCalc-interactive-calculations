...
class ProductAdminFrontend extends AbstractAdminFrontend
{
    ...
    public static function configuration()
    {
        ...
        foreach ($data as $item) {
            ...
            <tr>
                    ...
                    <td class="text-center"><button class="btn btn-danger" onclick="interactivecalculations_process_product_deletion(' . $item["id"] . ',\'' . $item["name"] . '\')"><span class="dashicons dashicons-trash"></span></button></td>
                </tr>';
        }
    ...
    <div class="container pt-5">
        <!-- Additon button -->
        <span><button class="button mb-2" data-toggle="modal" data-target="#' . $productCreationModal . '">+</button> ' . esc_html(__("Add New Product")) . '</span>
            <!-- Table -->
        ...
        return '<div class="modal mt-5 fade w-100 p-3" id="' . $modalId . '" role="dialog">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body p-5">
                              <h4 class="modal-title">' . esc_html(__("Edit Product")) . '</h4>
                              <form id="' . $modalId . '_form">
                              <div class="form-row interactivecalculations-product-form-row">
            ...
            . '
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-primary"  data-dismiss="modal" onclick="interactivecalculations_process_product_edition(\'' . $id . '\',\'' . $modalId . '\')">' . esc_html(__("Edit")) . '</button>
                            </div>
                          </div>
                        </div>
                      </div>';
        ...
        return '<div class="modal mt-5 fade w-100 p-3" id="' . $modalId . '"  role="dialog">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body p-5">
                              <h4 class="modal-title">' . esc_html(__("Create New Product")) . '</h4>
                              <form id="' . $modalId . '_form">
                              <div class="form-row interactivecalculations-product-form-row">
                                <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_name_form">' . esc_html(__("Name")) . '</label>
                                  <input id="' . $modalId . '_name_form" type="text" class="form-control" placeholder="' . esc_html(__("Product Name")) . '">
                                </div>
                                 <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_desc_form">' . esc_html(__("Description")) . '</label>
                                  <input id="' . $modalId . '_desc_form" type="text" class="form-control" placeholder="' . esc_html(__("Product Description")) . '" >
                                </div>
                                <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_price_form">' . esc_html(__("Price per Unit")) . '</label>
                                  <input id="' . $modalId . '_price_form" type="number" class="form-control" placeholder="' . esc_html(__("Product Price")) . '" >
                                </div>
                                <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_unit_form">' . esc_html(__("Unit")) . '</label>
                                  <input id="' . $modalId . '_unit_form" type="text" class="form-control" placeholder="' . esc_html(__("Product Unit")) . '" >
                                </div>
                                <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_min_quantity_form">' . esc_html(__("Minimal Quantity")) . '</label>
                                  <input id="' . $modalId . '_min_quantity_form" type="number" class="form-control" placeholder="' . esc_html(__("Product Minimal Quantity")) . '" >
                                </div>
                                 <div class="col interactivecalculations-edit-table-space-between">
                                  <label for="' . $modalId . '_display_type_form">' . esc_html(__("Display Type")) . '</label>
                                                                  ' .
            ...
            . '
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-danger mr-2" data-dismiss="modal">' . esc_html(__("Close")) . '</button>
                              <button type="button" class="btn btn-primary"  data-dismiss="modal" onclick="interactivecalculations_process_product_creation(\'' . $modalId . '\')">' . esc_html(__("Save")) . '</button>
                            </div>
                          </div>
                        </div>
                      </div>';
