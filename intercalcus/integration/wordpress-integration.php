...
function intercalcus_enqueue_page_dependencies() {
	wp_enqueue_script( 'intercalcus_pages_scripts', plugins_url( '/scripts/intercalcus_pages.js', INTERCALCUS_FILE ), array(), INTERCALCUS_VERSION, false );
	wp_enqueue_style( 'intercalcus_page_style', plugins_url( '/styles/intercalcus-pages-generic.css', INTERCALCUS_FILE ), array(), INTERCALCUS_VERSION, false );
}
