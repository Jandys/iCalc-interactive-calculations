...
class Slider extends DisplayType
{
    ...
    {
        if ($this->showValue) {
            return '<div id="displayValue-' . $this->id . '" class="icalcus-display-slider-value">' . $this->value . '</div>';
        }
    ...
    {
        $returnValue = '<input class="icalcus-calculation-slider ' . $this->classes . '" type="range" id="' . $this->id . '"';
