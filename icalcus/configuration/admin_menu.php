...
use icalcus\fe\MainMenuFrontend;
use icalcus\fe\ProductAdminFrontend;
use icalcus\fe\ServiceAdminFrontend;
use icalcus\fe\StatisticsAdminFrontend;

add_action('admin_menu', 'icalcus_admin_menu');
...
/**
 * Sets an authentication cookie for the icalcus plugin in the admin area.
 *
 ...
 * it requests a new token from the icalcus API and sets it as a cookie.
 *
 * @return void
...
function inter_calc_set_cookie()
{
    ...
    if (isset($_GET['page']) && in_array($_GET['page'], configurationSites)) {
        if (!isset($_COOKIE['icalcus-expiration']) ||
            !isset($_COOKIE['icalcus-token']) ||
            $_COOKIE['icalcus-expiration'] <= time()) {
            ...
            setcookie('icalcus-token', $issued_jwt_token, $expiration_time, '/');
            setcookie('icalcus-expiration', $expiration_time, $expiration_time, '/');
        }
    }
}
...
{
    if (is_admin()) {
        wp_enqueue_style('icalcus_main-styles', plugins_url('../styles/icalcus-main-sheetstyle.css', __FILE__), array(), ICALCUS_VERSION, false);
        add_action('wp_enqueue_style', 'icalcus_main-styles');

        echo '<div class="wrap">
        <h2>' . __("Inter Calcus Menu", "icalcus") . '</h2>';
        MainMenuFrontend::configuration();
        echo '</div>';

        icalcus_main_script_localization();

    }
}

function icalcus_main_script_localization()
{
    wp_enqueue_script('icalcus_main-script', plugins_url('../scripts/icalcus_main.js', __FILE__), array(), ICALCUS_VERSION, false);
    $localization_data = array(
        'id' => __("ID", "icalcus"),
        'name' => __("Name", "icalcus"),
        'description' => __("Description", "icalcus"),
        'pricePerUnit' => __("Price per Unit", "icalcus"),
        'unit' => __("Unit", "icalcus"),
        'minQuantity' => __("Minimal Quantity", "icalcus"),
        'displayType' => __("Display Type", "icalcus"),
        'createNewCalc' => __("Create New Calculation", "icalcus"),
        'newCalcTitle' => __("New Calculation title", "icalcus"),
        'editCurrentConfig' => __("Edit Current Configuration", "icalcus"),
        'saveCalc' => __("Save Calculation", "icalcus"),
        'calcList' => __("Calculation List", "icalcus"),
        'calcName' => __("Calculation Name", "icalcus"),
        'product' => __("Product", "icalcus"),
        'service' => __("Service", "icalcus"),
        'genericComp' => __("Generic Component", "icalcus"),
        'calcComp' => __("Calculation Component", "icalcus"),
        'preview' => __("Preview", "icalcus"),
        'none' => __("-- None --", "icalcus"),
        'showLabel' => __("Show Label", "icalcus"),
        'customLabel' => __("Custom Label", "icalcus"),
        'labelClasses' => __("Label Classes", "icalcus"),
        'inputClasses' => __("Input Classes", "icalcus"),
        'toAddMultipleClassesText' => __("To add multiple classes separate them by using semicolon: ';'", "icalcus"),
        'customCss' => __("Custom CSS", "icalcus"),
        'baseValue' => __("Base Value", "icalcus"),
        'uncheckedValue' => __("Unchecked Value", "icalcus"),
        'listOption' => __("Option", "icalcus"),
        'listValue' => __("Value", "icalcus"),
        'sliderMax' => __("Slider Max", "icalcus"),
        'showValue' => __("Show Value", "icalcus"),
        'sumPrefix' => __("Prefix", "icalcus"),
        'sumSuffix' => __("Suffix", "icalcus"),
        'subtractFromValue' => __("Original Value to Subtract from", "icalcus"),
        'complexCalcConf' => __("Complex calculation configuration", "icalcus"),
        'complexCalcAddComp' => __("Add Component Reference", "icalcus"),
        'personalCustomization' => __("Personal Customization", "icalcus"),
        'wrapperCustomClass' => __("Wrapper custom class", "icalcus"),
        'calcDescription' => __("Calculation Description", "icalcus"),
        'label' => __("Label", "icalcus"),
        'text' => __("Text", "icalcus"),
        'list' => __("List", "icalcus"),
        'numberInput' => __("Number Input", "icalcus"),
        'slider' => __("Slider", "icalcus"),
        'checkBox' => __("Checkbox", "icalcus"),
        'spacer' => __("Spacer", "icalcus"),
        'horizontalRule' => __("Horizontal Rule", "icalcus"),
        'sum' => __("Sum", "icalcus"),
        'productCalculation' => __("Product Calculation", "icalcus"),
        'subtractCalculation' => __("Subtract Calculation", "icalcus"),
        'complexCalculation' => __("Complex Calculation", "icalcus"),
        'errorNoServiceFound' => __("No Service found", "icalcus"),
        'errorNoCalculationComponentFound' => __("No Calculation Component found", "icalcus"),
        'errorNoGenericComponentFound' => __("No Generic Component found", "icalcus"),
        'errorNoProductFound' => __("No Product found", "icalcus"),
        'errorFillPreviousOptions' => __("Please fill previous option and value", "icalcus"),
        'errorNoValidComponents' => __("There are no valid components to be saved to calculation", "icalcus"),
        'defaultDescription' => __("Default calculation description", "icalcus"),
    );
    wp_localize_script('icalcus_main-script', 'icalcusMainScriptLocalization', $localization_data);

    add_action('wp_enqueue_scripts', 'icalcus_main-script');
...
function ic_menu_services_configuration()
{
    ...
    if (is_admin()) {
        echo '<div class="wrap">
        <h2>' . __("Services Menu", "icalcus") . '</h2>';
...
function ic_menu_statistics()
{
    if (is_admin()) {
        ...
        echo '<div class="wrap">
        <h2>' . __("Statistics Menu", "icalcus") . '</h2>';
