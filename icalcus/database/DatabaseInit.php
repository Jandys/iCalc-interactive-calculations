...
class DatabaseInit
{
    ...
    public static function init()
    {
        ...
        $icalcusDesc = IcalcusulationsDescription::create_table();
        $icalcuss = Icalcusulations::create_table();

        // Returns true if all table creation queries executed successfully, false otherwise.
        return $product && $service && $unit && $icalcusDesc && $icalcuss;
    }
    ...
    public static function clearAll()
    {
        ...
        Service::clearAll();
        Unit::clearAll();
        IcalcusulationsDescription::clearAll();
        Icalcusulations::clearAll();
    }
